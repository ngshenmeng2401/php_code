...
$sqlloadmoment2 = "SELECT a.email as writerEmail, a.post_id, a.content, a.img_status as moment_img, a.date_post, a.likes, d.username, d.phone_no, d.img_status as profile_img 
FROM tbl_post a 
JOIN tbl_user d 
ON d.email= a.email 
WHERE a.email = '$email' 
...
SELECT c.friend_email as writerEmail, a.post_id, a.content, a.img_status as moment_img, a.date_post, a.likes, d.username, d.phone_no, d.img_status as profile_img 
FROM tbl_post a 
JOIN tbl_friend c 
ON c.friend_email = a.email 
JOIN tbl_user d 
ON d.email= a.email 
WHERE c.email = '$email' 
ORDER BY post_id DESC";

$result = $con->query($sqlloadmoment2);
