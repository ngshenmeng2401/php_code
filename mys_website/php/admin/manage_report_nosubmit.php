...
<head>
    ...
    <title>Manage Report No Submit</title>
    <link
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item me-3">
                    <a class="nav-link text-light" href="login.php">Dashboard</a>
                </li>
                <li class="nav-item me-3">
                    <a class="nav-link text-light" href="login.php">Add Profile</a>
                </li>
                <li class="nav-item dropdown me-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <li><a class="dropdown-item active" href="#">Report</a></li>
                      <li><a class="dropdown-item" href="#">Submission</a></li>
                    </ul>
                </li>
                <li class="nav-item me-3">
                    <a class="nav-link text-light" href="login.php">User Personal Details</a>
                </li>
            </ul>
            <!-- <form class="d-flex">
    ...
    <div class="container">
        <div class="row my-4 px-3 px-sm-0">
            <div class="card shadow mb-4">
                <div class="card-body ">
                    <h1 class="text-center mb-3">User List have not Submit</h1>
